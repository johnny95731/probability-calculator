...
const redirect_45404_45global = /* @__PURE__ */ defineNuxtRouteMiddleware((to) => {
...
const vuetify_F4zXYcNIwC = /* @__PURE__ */ defineNuxtPlugin((app) => {
...
const __nuxt_component_0 = /* @__PURE__ */ defineComponent$1({
  ...
  setup(props, { attrs, slots, expose }) {
    ...
    let previousPageKey;
    expose({ pageRef });
    const _layoutMeta = inject$1(LayoutMetaSymbol, null);
    let vnode;
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent$1({
  ...
  setup(__props) {
    useHead({
      meta: [
        { name: "description", content: "機率計算機，可計算離散機率分布、連續機率分布以及事件機率。" }
      ]
    });
    return (_ctx, _cache) => {
...
export {
  ...
  withDirectives as N,
  propsFactory as O,
  genericComponent as P,
  useProxiedModel as Q,
  IN_BROWSER as R,
  nextTick as S,
  useRender as T,
  focusableChildren as U,
  getUid as V,
  filterInputAttrs as W,
  shallowRef as X,
  renderSlot as Y,
  normalizeStyle as Z,
  render as _,
  ...
  provideDefaults as ad,
  toRef as ae,
  resolveDirective as af,
  inject$1 as ag,
  wrapInArray as ah,
  matchesSelector as ai,
  omit as aj,
  useLocale as ak,
  getCurrentInstanceName as al,
  ...
  convertToUnit as at,
  getPropertyFromItem as au,
  focusChild as av,
  destructComputed as aw,
  clamp as ax,
  watchEffect as ay,
  effectScope as az,
  onNuxtReady as b,
  camelize as b0,
  onUpdated as b1,
  findChildrenWithProvide as b2,
  makeDisplayProps as b3,
  useGoTo as b4,
  deprecate as b5,
  includes as b6,
  toRefs as b7,
  isCssColor as b8,
  isParsableColor as b9,
  parseColor as ba,
  getForeground as bb,
  SUPPORTS_INTERSECTION as bc,
  useIcon as bd,
  flattenFragments as be,
  Text as bf,
  hasEvent as bg,
  keyCodes as bh,
  requestIdleCallback as c,
  defineComponent$1 as d,
  onBeforeUnmount as e,
  cancelIdleCallback as f,
  resolveComponent as g,
  h,
  computed as i,
  hasProtocol as j,
  resolveRouteObject as k,
  joinURL as l,
  navigateTo as m,
