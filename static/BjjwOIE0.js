...
let Tooltip$1 = (_a = class extends Element {
  constructor(config) {
    super();
    this.opacity = 0;
    this._active = [];
...
}, __publicField(_a, "positioners", positioners), _a);
var plugin_tooltip = {
  id: "tooltip",
  _element: Tooltip$1,
  positioners,
...
const __nuxt_component_0 = Object.assign(_sfc_main, { __name: "VChart" });
